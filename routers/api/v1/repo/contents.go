...
// GetContents get contents of a file or directory via
func GetContents(ctx *context.APIContext) {
	// swagger:operation GET /repos/{owner}/{repo}/contents/{path} repository repoGetContents
	// ---
	...
	commit, err := gitRepo.GetCommit(strings.Trim(ctx.Query("ref"), " "))
	if err != nil {
